...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <td>1</td>
      <td>1</td>
      <td><img src="images/11.jpg" alt="" width="50" height="50" /></td>  
      <td>1</td>
    ...
    <tr>
      ...
      <td>3</td>
      <td><div class="button-group">
      <a class="button border-main" href="UserModServlet?flag=update"><span class="icon-edit"></span> 修改</a>
      <a class="button border-red" href="javascript:void(0)" onclick="return del(1,1)"><span class="icon-trash-o"></span> 删除</a>
      </div></td>
    </tr>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="UserModServlet">    
     <div class="form-group">
        <div class="label">
          <label>ID：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" name="id" data-validate="required:请输入您要更改的用户所属id" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
